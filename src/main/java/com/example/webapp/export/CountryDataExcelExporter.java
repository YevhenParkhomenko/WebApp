...
public class CountryDataExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<CountryEntity> countryEntities;

    public CountryDataExcelExporter(List<CountryEntity> countryEntities) {
    ...
    private void writeDataLines() {
        ...
        for (CountryEntity countryEntity : countryEntities) {
            ...
            createCell(row, columnCount++, countryEntity.getId(), style);
            createCell(row, columnCount++, countryEntity.getName(), style);
        }
    }
